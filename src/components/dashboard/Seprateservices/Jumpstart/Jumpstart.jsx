...
const Jumpstart = ({ handleServiceClick }) => {
  ...
  return (
    <Box>
      ...
      {/* Manage Heading */}
      <p className="font-redhat font-semibold text-2xl py-8">Jumpstart</p>
