      ...
      <div className="flex justify-between pt-8">
        ...
        <div className="w-[30%] flex flex-col gap-6">
          <div className="px-4 py-6 bg-white rounded-lg" style={{boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)",}}>
            <p className="font-redhat font-semibold text-2xl">Upcoming events</p>
            <div className="flex gap-4 items-center py-6 border-b border-dashed border-[#DDDDDD]">
                <img src={eventimage} alt="" className="w-[35%]" />
                <div className=""><p className="font-semibold text-xl font-sans">Lorem ipsum dolor sit consectuer</p>
                <p className="font-sans text-base text-[#777777]">New Jersey, USA</p>
                </div>
            </div>
            <div className="flex gap-4 items-center py-6 border-b border-dashed border-[#DDDDDD]">
                <img src={eventimage} alt="" className="w-[35%]" />
