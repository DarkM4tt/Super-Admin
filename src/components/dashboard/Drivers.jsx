...
import { useGetAllDriversQuery } from "../../features/Driver/driverSlice";
  ...
  useEffect(() => {
    if (allornew == "New") {
      const filtereddriversdata = driversData.filter((driver) =>
        allornew === "New" ? !driver.isActive : driver.isActive
      );
  ...
  return (
    <div className="flex flex-col gap-8 p-4">
      ...
      <div className="flex gap-6">
        <div
          className={`pb-[6px] pr-3 ${
            allornew === "All" ? "border-b-[3px] border-[#18C4B8]" : ""
          }`}
          onClick={() => setallornew("All")}
        >
          <p
            className={`font-redhat font-bold text-base ${
              allornew !== "All" ? "text-[#777777] font-normal" : ""
            }`}
          >
            Drivers
          </p>
        ...
        <div
          className={`pb-[6px] pr-3 ${
            allornew === "New" ? "border-b-[3px] border-[#18C4B8]" : ""
          }`}
          onClick={() => setallornew("New")}
        >
          <p
            className={`font-redhat font-bold text-base ${
              allornew !== "New" ? "text-[#777777] font-normal" : ""
            }`}
          >
            New applicants
          </p>
                    ...
                    {filteredDrivers.map((driver, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            {driver?.organization_details?.organization_name !==
                            undefined ? (
              ...
              >
                <div className="flex gap-3 ">
                  ...
                  <div className="flex flex-col justify-between py-1">
                    ...
                    <p className="font-bold text-base font-redhat">
                      Driver Name: {org?.driver_name}
                    </p>
                    <p className="font-bold text-base font-redhat">
                      Vehicle: {org.totalVehicles}
                    </p>
                  </div>
                </div>
