    ...
    return (
      ...
      >
        <div className="flex justify-between">
          <p className="font-redhat font-semibold text-2xl">All campaign</p>
        </div>
        <TableContainer>
          <Table>
            {/* Table Header */}
            ...
            >
              <TableRow>
                {["Campaign name", "Duration", "Spends", "Impressions", "Current status"].map((header) => (
    ...
    <div className=" bg-backGround">
      <div className="flex justify-between items-center font-redhat text-base font-semibold ">
          <p className="font-redhat font-semibold text-base flex items-center">
            <span className="text-[#777777] pr-2">{"Services > BOLD Ads  >"} </span>
            {"BOLD Promotions > Location details"}
          </p>
      ...
      <div className="flex justify-between pt-8">
        ...
        <div className="w-[30%] flex flex-col gap-6">
          <div className="px-4 py-6 bg-white rounded-lg" style={{boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)",}}>
            <p className="font-redhat font-semibold text-2xl">Ongoing booking</p>
            <div className="flex gap-4 items-center py-6 border-b border-dashed border-[#DDDDDD]">
                <img src={rentalonlinebooking} alt="" />
                <div className=""><p className="font-semibold text-xl font-sans"><span className="underline pt-2">Joseph J </span> | 2 days</p>
                <p className="font-sans text-base text-[#777777]">Vehicle : JH01 AM SSK01</p>
                </div>
            </div>
            <div className="flex gap-4 items-center py-6 border-b border-dashed border-[#DDDDDD]">
                <img src={rentalonlinebooking} alt="" />
