  ...
  return (
    <div className="flex items-center w-full">
      <div className="flex-grow">
        ...
        <p className="pt-1 font-redhat font-semibold text-xs">Overall acceptance ratio</p>
        <div className="pt-3 flex flex-col gap-2">
          <p className="font-redhat text-xs">
            <span className="pr-2">
              <FiberManualRecordIcon fontSize="6px" className="text-[#344BFD]" />
            </span>
            Accepted
          </p>
          <p className="font-redhat text-xs">
            <span className="pr-2">
              <FiberManualRecordIcon fontSize="6px" className="text-[#F4A79D]" />
            </span>
            Cancelled by driver
          </p>
          <p className="font-redhat text-xs">
            <span className="pr-2">
              <FiberManualRecordIcon fontSize="6px" className="text-[#F68D2B]" />
            </span>
